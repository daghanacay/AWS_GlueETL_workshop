...
- The objectCount, showing how many files were found
- The sizeKey property, showing total dataset size
- The recordCount property, showing total number of records
- The compressionType, showing the files are compressed in bzip2
